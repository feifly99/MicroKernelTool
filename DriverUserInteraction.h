...
#define ____$_INITIALIZE_DRIVER_SETTINGS_$____              CTL_CODE(FILE_DEVICE_UNKNOWN, 0x8001, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define ____$_FURTHER_SEARCH_PATTERN_$____					CTL_CODE(FILE_DEVICE_UNKNOWN, 0x8008, METHOD_BUFFERED, FILE_ANY_ACCESS)
